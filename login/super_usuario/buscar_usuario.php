...
<div class="container-busqueda">
 <form  name="fbuscar" method="POST" onsubmit="return validar();">
  <input class="idbuscar" type="text" name="idusu" id="idusu" value="<?php if($_POST){echo $_POST['idusu'];}?>" placeholder="Ingrese el Usuario:" >
...
<a href="crear_usuario.php?id=<?php echo $idusu?>"><button class="boton-modificar" type="button" name="bModificar" id="bModificar" onclick="return validar()">Modificar</button></a>

<a href="eliminar_usuario.php?id=<?php echo $idusu?>"><button class="boton-eliminar" type="button" name="bEliminar" id="bEliminar" onclick="return confirmar()">Eliminar</button></a>
...
<!-- SCRIPTS -->
<script src="/seveclon/js/botones_usuario.js"></script>
